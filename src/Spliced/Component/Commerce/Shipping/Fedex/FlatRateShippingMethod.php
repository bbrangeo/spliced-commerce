...
class FlatRateShippingMethod extends ConfigurableShippingMethod
{
    ...
    public function getPrice()
    {
        ...
        if($this->getOption('additional_cost_over_x_items') && $this->getOption('additional_cost_over_x')){
            $basePriceGoodUntil = (int) $this->getOption('additional_cost_over_x_items');
            $addEveryModulesAmount = (float) $this->getOption('additional_cost_over_x');
            $additionalCheckRegexp = $this->getOption('additional_cost_over_x_items_regexp');
            $addEveryModulesAmountRegexp = $this->getOption('additional_cost_over_x_regexp');
