...
abstract class Event extends BaseEvent
{
    ...
    const EVENT_CMS_PAGE_SAVE     = 'commerce.cms_page.save';
    const EVENT_CMS_PAGE_UPDATE   = 'commerce.cms_page.update';
    const EVENT_CMS_PAGE_DELETE   = 'commerce.cms_page.delete';
}
